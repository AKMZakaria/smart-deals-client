  ...
  return (
    <div>
      ...
      <div>
        ...
        <dialog ref={bidModalRef} className="modal text-center modal-bottom sm:modal-middle">
          <div className="modal-box">
            ...
            <form className="" onSubmit={handleBidSubmit}>
              <fieldset className="fieldset">
                ...
                <input type="text" name="bid" className="input w-full" placeholder="Enter a bid" />
